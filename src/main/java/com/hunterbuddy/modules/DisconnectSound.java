...
public class DisconnectSound extends Module {
    ...
    private final Setting<List<SoundEvent>> sound = sgGeneral.add(new SoundEventListSetting.Builder()
        .name("sound")
        .description("Sound to play on disconnect.")
    ...
    public DisconnectSound() {
        super(HunterBuddyAddon.UTILITY_CATEGORY, "disconnect-sound", "Plays a sound when the Disconnected Screen appears (e.g., when kicked).");
