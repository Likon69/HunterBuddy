...
public class VanityESP extends Module {
    ...
    public VanityESP() {
        super(HunterBuddyAddon.HUNTER_BUDDY_CATEGORY, "hb-vanityesp", "Unified ESP for decorative items and special blocks. (HunterBuddy version — renamed to avoid conflict with JEFF mod.)");
